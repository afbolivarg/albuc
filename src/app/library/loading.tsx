export default function LibraryLoading() {
  return (
    <div className="relative flex h-full flex-col bg-[#faf9f6]">
      <div className="animate-pulse px-[18px] pt-[max(16px,env(safe-area-inset-top,0px))] pb-4 min-[710px]:px-10">
      ...
      <div className="flex min-h-0 flex-1 flex-col justify-center gap-[42px] px-[18px] pb-[calc(92px+env(safe-area-inset-bottom,0px))] min-[710px]:px-10">
      ...
      <div className="absolute bottom-[max(12px,env(safe-area-inset-bottom,0px))] left-1/2 flex -translate-x-1/2 items-center gap-3.5 rounded-full border border-border bg-background px-3 py-[9px] pl-[18px]">
